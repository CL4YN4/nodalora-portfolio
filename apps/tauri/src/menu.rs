...
pub fn create_menu<R: Runtime>(app: &AppHandle<R>) -> Result<Menu<R>, tauri::Error> {
    let app_menu = SubmenuBuilder::new(app, "Nodalora Portfolio")
    ...
    let help_menu = SubmenuBuilder::new(app, "Help")
        ...
        .separator()
        .item(&MenuItemBuilder::with_id("show_about_dialog", "About Nodalora Portfolio").build(app)?)
        .build()?;
            ...
            tauri::async_runtime::spawn(async move {
                match crate::updater::check_for_update(app_handle.clone()).await {
                    ...
                    Ok(None) => {
                        ...
                        app_handle
                            .dialog()
                            .message("You're already running the latest version of Nodalora Portfolio.")
