...
describe("IssueDetailSheet", () => {
  ...
  it("renders transfer date diagnostics as date-filtered transfer rows", () => {
    renderIssueSheet({
      ...
      title: "2 transfer dates need review",
      message:
        "Some transfers are unclear: Nodalora Portfolio cannot tell if money moved between your own accounts or entered/left your portfolio.",
      navigateAction: {
        route: "/activities",
        label: "Review Transactions",
      ...
      diagnostics: [
        {
          ...
          title: "No price found",
          explanation:
            "Nodalora Portfolio is missing the exact market price for this holding on the affected date.",
          date: "2026-06-01",
          evidence: [
            {
              label: "Asset",
